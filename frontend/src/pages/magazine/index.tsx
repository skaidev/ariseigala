...
// import Tilt = require("react-vanilla-tilt")
                        ...
                        <div className="container mb-2 first-main d-flex flex-column-reverse flex-md-row align-items-md-center">
                            <div className="left">
                                ...
                                <p className="poppins fs-5 mb-4 p-0 ">
                                    ...
                                    adipiscing elit. Egestas in vivamus nisi non
                                    vivamus etiam tincidunt nec aliquam.
                                    Adipiscing purus a tincidunt faucibus felis
                                    mattis elementum massa
                                </p>
