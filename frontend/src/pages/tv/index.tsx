            ...
            <div className="tv-body-main-video d-flex flex-column flex-lg-row">
              <div className="left">
                ...
                <div className="video-title">
                  <div className="my-2">
                    <p className="p-0 mb-1 font-18 fw-bold">
                      Tempus ornare morbi molestie purus dis et. Pellentesque
                    </p>
                    <span className="text-muted ">3rd June 2021</span>
                  </div>
                  <div className="line-thin bg-dark mt-3" />
                  <p className="mb-0 py-2"> 255 Comments</p>
                  <div className="line-thin bg-dark" />
                </div>
...
const VideoComment = () => {
  return (
    <div className="col comments-main ">
      <div className="card border-0 comments-main-card p-0 d-flex align-items-md-start flex-column flex-md-row">
        ...
        <div className="card-body p-0 comments-main-card-body">
          ...
          <p>
            Nunc amet purus at amet elementum ornare tincidunt phasellus
            habitant. Sed dui, leo amet, tristique sed porta magnis tincidunt
            massa. In orci scelerisque nunc cras euismod suscipit non ut orci.
            Purus ac imperdiet laoreet quam fames. Nunc enim malesuada volutpat
            mattis. Praesent ipsum lacinia dis metus. In amet, eget tellus
            facilisi pellentesque. Tortor integer urna libero phasellus.
            Ullamcorper congue volutpat vel.
          </p>
        </div>
      </div>
    </div>
